...
import { djangoCats } from './data/djangoData'
...
const TOPICS = [
  ...
  { id: 'django', label: 'Django',   badge: '4.x / 5.x', cats: djangoCats, color: '#092E20', textColor: '#44B78B' },
]

// Each topic gets its own isolated progress store key
const STORE_KEYS = { js: 'jsmm_prog_v1', react: 'reactmm_prog_v1', next: 'nextmm_prog_v1', ai: 'aimm_prog_v1', leet: 'leetmm_prog_v1', django: 'djangomm_prog_v1' }
